...
export default function Hero() {
  ...
  return (
    <section className="relative bg-gradient-to-br from-blue-50 via-white to-blue-50 flex items-center overflow-hidden" style={{ paddingTop: 'clamp(4rem, 10vh, 8rem)', paddingBottom: 'clamp(4rem, 10vh, 8rem)' }}>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <Link href="https://wa.me/917667432929" target="_blank" rel="noopener noreferrer">
                <motion.div
                  className="w-full sm:w-auto px-8 py-4 bg-white text-gray-700 rounded-xl font-semibold border-2 border-gray-200 flex items-center justify-center gap-2 cursor-pointer"
                ...
                <div key={index} className="flex items-center gap-8">
                  <div>
                    <motion.p
                      ...
                      transition={prefersReducedMotion ? {} : { delay: 0.9 + index * 0.1, type: "spring", stiffness: 200 }}
                    >
                      {stat.value}
                    </motion.p>
          ...
          <div className="relative hidden lg:flex items-center justify-center">
            <motion.div
              ...
              transition={prefersReducedMotion ? {} : { duration: 0.6, delay: 0.3, y: { duration: 4.5, repeat: Infinity, ease: "easeInOut" } }}
            >
            ...
            {[
              ...
              <motion.div
                ...
                initial={prefersReducedMotion ? {} : { opacity: 0, scale: 0 }}
                animate={prefersReducedMotion ? {} : el.animate}
                transition={prefersReducedMotion ? {} : el.transition}
              >
